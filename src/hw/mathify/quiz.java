...
public class quiz extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("ARITH", "Started");        
        application = (Mathify) this.getApplication();
		...
		options_list.setOnItemClickListener(new OnItemClickListener(){			
			...
			public void onItemClick(AdapterView<?> arg0, View arg, int position,
				...
				if(noAnswered-noCorrect>=3)
				{
					s="  Game Over All Lives Used "+"\n";
					
					
				}
				if ( noAnswered < noQuestions && noAnswered-noCorrect<3){
				    generateQuestion();
				    options.clear();
				    loadOptions();
				    options_list=(ListView)findViewById(R.id.option_list);
    ...
    private void gensum() {
    	...
    	summary.setText(  s+"  Attempted          :" + total+"\n"+ 
    			          "  Questions correct  :"+c +"\n"+ 
    ...
    {
    	int temp;
    	operation = (int)(Math.random()*17.0);
        ...
        case 2:
            ...
            case 3:if ( operand1Value < operand2Value ) {
        		answerValue = operand2Value;
        		operand2Value = operand1Value;
        		operand1Value = answerValue;
        	    }
        	    questionText = "Remainder of "+ operand1Value + ", " + operand2Value;
        	    answerValue = operand1Value % operand2Value;
           
            case 4:
        	    questionText = "("+operand1Value + " + " + operand2Value+")"+operand3Value+" + "+operand4Value;
                ...
                case 7:
            	    ...
            	    break;
                case 8:
            	    questionText = operand1Value + " * " + operand2Value+" - "+operand3Value;
            	    answerValue = (operand1Value * operand2Value) - operand3Value;
            	    break;
